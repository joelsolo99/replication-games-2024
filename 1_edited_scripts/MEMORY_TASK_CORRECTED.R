...
t.test(x = agg_response_df$RT[agg_response_df$orientation == "facing"], 
       y = agg_response_df$RT[agg_response_df$orientation == "away"], 
       paired = TRUE, 
       var.equal = TRUE)
lsr::cohensD(
  x = agg_response_df$RT[agg_response_df$orientation == "facing"],
  y = agg_response_df$RT[agg_response_df$orientation == "away"],
  method = "paired"
)
